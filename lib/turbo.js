    ...
    return {
        ...
        execute: function () {
            ...
            (function (TokenKind) {
                ...
                TokenKind[TokenKind["SUPER"] = 50] = "SUPER";
                TokenKind[TokenKind["CONST"] = 51] = "CONST";
                TokenKind[TokenKind["CONTINUE"] = 52] = "CONTINUE";
                TokenKind[TokenKind["DECLARE"] = 53] = "DECLARE";
                TokenKind[TokenKind["ELSE"] = 54] = "ELSE";
                TokenKind[TokenKind["ENUM"] = 55] = "ENUM";
                TokenKind[TokenKind["EXPORT"] = 56] = "EXPORT";
                TokenKind[TokenKind["EXTENDS"] = 57] = "EXTENDS";
                TokenKind[TokenKind["FALSE"] = 58] = "FALSE";
                TokenKind[TokenKind["FUNCTION"] = 59] = "FUNCTION";
                TokenKind[TokenKind["ANYFUNC"] = 60] = "ANYFUNC";
                TokenKind[TokenKind["IF"] = 61] = "IF";
                TokenKind[TokenKind["IMPLEMENTS"] = 62] = "IMPLEMENTS";
                TokenKind[TokenKind["INTERNAL_IMPORT"] = 63] = "INTERNAL_IMPORT";
                TokenKind[TokenKind["EXTERNAL_IMPORT"] = 64] = "EXTERNAL_IMPORT";
                TokenKind[TokenKind["LET"] = 65] = "LET";
                TokenKind[TokenKind["NEW"] = 66] = "NEW";
                TokenKind[TokenKind["DELETE"] = 67] = "DELETE";
                TokenKind[TokenKind["NULL"] = 68] = "NULL";
                TokenKind[TokenKind["UNDEFINED"] = 69] = "UNDEFINED";
                TokenKind[TokenKind["OPERATOR"] = 70] = "OPERATOR";
                TokenKind[TokenKind["PRIVATE"] = 71] = "PRIVATE";
                TokenKind[TokenKind["PROTECTED"] = 72] = "PROTECTED";
                TokenKind[TokenKind["PUBLIC"] = 73] = "PUBLIC";
                TokenKind[TokenKind["RETURN"] = 74] = "RETURN";
                TokenKind[TokenKind["SIZEOF"] = 75] = "SIZEOF";
                TokenKind[TokenKind["STATIC"] = 76] = "STATIC";
                TokenKind[TokenKind["THIS"] = 77] = "THIS";
                TokenKind[TokenKind["TRUE"] = 78] = "TRUE";
                TokenKind[TokenKind["UNSAFE"] = 79] = "UNSAFE";
                TokenKind[TokenKind["JAVASCRIPT"] = 80] = "JAVASCRIPT";
                TokenKind[TokenKind["START"] = 81] = "START";
                TokenKind[TokenKind["VIRTUAL"] = 82] = "VIRTUAL";
                TokenKind[TokenKind["VAR"] = 83] = "VAR";
                TokenKind[TokenKind["WHILE"] = 84] = "WHILE";
                // Preprocessor
                TokenKind[TokenKind["PREPROCESSOR_DEFINE"] = 85] = "PREPROCESSOR_DEFINE";
                TokenKind[TokenKind["PREPROCESSOR_ELIF"] = 86] = "PREPROCESSOR_ELIF";
                TokenKind[TokenKind["PREPROCESSOR_ELSE"] = 87] = "PREPROCESSOR_ELSE";
                TokenKind[TokenKind["PREPROCESSOR_ENDIF"] = 88] = "PREPROCESSOR_ENDIF";
                TokenKind[TokenKind["PREPROCESSOR_ERROR"] = 89] = "PREPROCESSOR_ERROR";
                TokenKind[TokenKind["PREPROCESSOR_IF"] = 90] = "PREPROCESSOR_IF";
                TokenKind[TokenKind["PREPROCESSOR_NEEDED"] = 91] = "PREPROCESSOR_NEEDED";
                TokenKind[TokenKind["PREPROCESSOR_NEWLINE"] = 92] = "PREPROCESSOR_NEWLINE";
                TokenKind[TokenKind["PREPROCESSOR_UNDEF"] = 93] = "PREPROCESSOR_UNDEF";
                TokenKind[TokenKind["PREPROCESSOR_WARNING"] = 94] = "PREPROCESSOR_WARNING";
            })(TokenKind || (TokenKind = {}));
    ...
    return {
        ...
        execute: function () {
            ...
            ParserContext = class ParserContext {
                ...
                parseSuper() {
                    let token = this.current;
                    assert(token.kind == lexer_1.TokenKind.SUPER);
                    this.advance();
                    if (!this.expect(lexer_1.TokenKind.LEFT_PARENTHESIS)) {
                        return null;
                    }
                    ...
                    return node_1.createSuper().withRange(token.range);
                }
                parseEnum(firstFlag) {
                    let token = this.current;
                ...
                parseStatement(mode) {
                    ...
                    if (this.peek(lexer_1.TokenKind.SUPER))
...
System.register("node", ["symbol"], function (exports_23, context_23) {
    ...
    exports_23("createSuper", createSuper);
    ...
    return {
        ...
        execute: function () {
            ...
            (function (NodeKind) {
                ...
                NodeKind[NodeKind["SUPER"] = 15] = "SUPER";
                NodeKind[NodeKind["CONSTANTS"] = 16] = "CONSTANTS";
                NodeKind[NodeKind["CONTINUE"] = 17] = "CONTINUE";
                NodeKind[NodeKind["EMPTY"] = 18] = "EMPTY";
                NodeKind[NodeKind["ENUM"] = 19] = "ENUM";
                NodeKind[NodeKind["EXPRESSION"] = 20] = "EXPRESSION";
                NodeKind[NodeKind["FUNCTION"] = 21] = "FUNCTION";
                NodeKind[NodeKind["IF"] = 22] = "IF";
                NodeKind[NodeKind["RETURN"] = 23] = "RETURN";
                NodeKind[NodeKind["UNSAFE"] = 24] = "UNSAFE";
                NodeKind[NodeKind["JAVASCRIPT"] = 25] = "JAVASCRIPT";
                NodeKind[NodeKind["START"] = 26] = "START";
                NodeKind[NodeKind["VARIABLES"] = 27] = "VARIABLES";
                NodeKind[NodeKind["WHILE"] = 28] = "WHILE";
                // Expressions
                ...
                NodeKind[NodeKind["ANY"] = 36] = "ANY";
                NodeKind[NodeKind["INT32"] = 37] = "INT32";
                NodeKind[NodeKind["INT64"] = 38] = "INT64";
                NodeKind[NodeKind["FLOAT32"] = 39] = "FLOAT32";
                NodeKind[NodeKind["FLOAT64"] = 40] = "FLOAT64";
                NodeKind[NodeKind["ARRAY"] = 41] = "ARRAY";
                NodeKind[NodeKind["GENERIC"] = 42] = "GENERIC";
                NodeKind[NodeKind["NAME"] = 43] = "NAME";
                NodeKind[NodeKind["NEW"] = 44] = "NEW";
                NodeKind[NodeKind["DELETE"] = 45] = "DELETE";
                NodeKind[NodeKind["NULL"] = 46] = "NULL";
                NodeKind[NodeKind["UNDEFINED"] = 47] = "UNDEFINED";
                NodeKind[NodeKind["PARSE_ERROR"] = 48] = "PARSE_ERROR";
                NodeKind[NodeKind["SIZE_OF"] = 49] = "SIZE_OF";
                NodeKind[NodeKind["STRING"] = 50] = "STRING";
                NodeKind[NodeKind["THIS"] = 51] = "THIS";
                NodeKind[NodeKind["TYPE"] = 52] = "TYPE";
                // Unary expressions
                NodeKind[NodeKind["ADDRESS_OF"] = 53] = "ADDRESS_OF";
                NodeKind[NodeKind["COMPLEMENT"] = 54] = "COMPLEMENT";
                NodeKind[NodeKind["DEREFERENCE"] = 55] = "DEREFERENCE";
                NodeKind[NodeKind["NEGATIVE"] = 56] = "NEGATIVE";
                NodeKind[NodeKind["NOT"] = 57] = "NOT";
                NodeKind[NodeKind["POINTER_TYPE"] = 58] = "POINTER_TYPE";
                NodeKind[NodeKind["POSITIVE"] = 59] = "POSITIVE";
                NodeKind[NodeKind["POSTFIX_DECREMENT"] = 60] = "POSTFIX_DECREMENT";
                NodeKind[NodeKind["POSTFIX_INCREMENT"] = 61] = "POSTFIX_INCREMENT";
                NodeKind[NodeKind["PREFIX_DECREMENT"] = 62] = "PREFIX_DECREMENT";
                NodeKind[NodeKind["PREFIX_INCREMENT"] = 63] = "PREFIX_INCREMENT";
                // Binary expressions
                NodeKind[NodeKind["ADD"] = 64] = "ADD";
                NodeKind[NodeKind["ASSIGN"] = 65] = "ASSIGN";
                NodeKind[NodeKind["BITWISE_AND"] = 66] = "BITWISE_AND";
                NodeKind[NodeKind["BITWISE_OR"] = 67] = "BITWISE_OR";
                NodeKind[NodeKind["BITWISE_XOR"] = 68] = "BITWISE_XOR";
                NodeKind[NodeKind["DIVIDE"] = 69] = "DIVIDE";
                NodeKind[NodeKind["EQUAL"] = 70] = "EQUAL";
                NodeKind[NodeKind["EXPONENT"] = 71] = "EXPONENT";
                NodeKind[NodeKind["GREATER_THAN"] = 72] = "GREATER_THAN";
                NodeKind[NodeKind["GREATER_THAN_EQUAL"] = 73] = "GREATER_THAN_EQUAL";
                NodeKind[NodeKind["LESS_THAN"] = 74] = "LESS_THAN";
                NodeKind[NodeKind["LESS_THAN_EQUAL"] = 75] = "LESS_THAN_EQUAL";
                NodeKind[NodeKind["LOGICAL_AND"] = 76] = "LOGICAL_AND";
                NodeKind[NodeKind["LOGICAL_OR"] = 77] = "LOGICAL_OR";
                NodeKind[NodeKind["MULTIPLY"] = 78] = "MULTIPLY";
                NodeKind[NodeKind["NOT_EQUAL"] = 79] = "NOT_EQUAL";
                NodeKind[NodeKind["REMAINDER"] = 80] = "REMAINDER";
                NodeKind[NodeKind["SHIFT_LEFT"] = 81] = "SHIFT_LEFT";
                NodeKind[NodeKind["SHIFT_RIGHT"] = 82] = "SHIFT_RIGHT";
                NodeKind[NodeKind["SUBTRACT"] = 83] = "SUBTRACT";
                //JavaScript
                NodeKind[NodeKind["JS_NUMBER"] = 84] = "JS_NUMBER";
                NodeKind[NodeKind["JS_OBJECT"] = 85] = "JS_OBJECT";
                NodeKind[NodeKind["JS_STRING"] = 86] = "JS_STRING";
                NodeKind[NodeKind["JS_ARRAY"] = 87] = "JS_ARRAY";
            })(NodeKind || (NodeKind = {}));
