            ...
            ParserContext = class ParserContext {
                ...
                parsePrefix(mode) {
                    ...
                    if (mode == ParseKind.EXPRESSION) {
                        ...
                        if (this.eat(lexer_1.TokenKind.SUPER)) {
...
System.register("checker", ["symbol", "type", "node", "compiler", "log", "scope", "stringbuilder", "imports", "const"], function (exports_20, context_20) {
    ...
    function initialize(context, node, parentScope, mode) {
        ...
        if (kind == node_9.NodeKind.CLASS || kind == node_9.NodeKind.ENUM) {
            ...
            if (extendNode && extendNode.kind == node_9.NodeKind.EXTENDS) {
            ...
            if (symbol.kind == symbol_8.SymbolKind.FUNCTION_INSTANCE) {
                ...
                if (superSymbol) {
                    node.insertChildAfter(node.functionFirstArgument(), node_9.createVariable("super", node_9.createType(superSymbol.resolvedType), null));
                }
    ...
    function resolve(context, node, parentScope) {
        ...
        else if (kind == node_9.NodeKind.PARAMETER || kind == node_9.NodeKind.PARAMETERS) {
            // let symbol = node.symbol;
        }
        else if (kind == node_9.NodeKind.VARIABLE) {
            let symbol = node.symbol;
        ...
        else if (kind == node_9.NodeKind.SUPER) {
            let symbol = parentScope.findNested("super", scope_2.ScopeHint.NORMAL, scope_2.FindNested.NORMAL);
            if (symbol == null) {
        ...
        execute: function () {
            ...
            Symbol = class Symbol {
                ...
                superSymbol() {
                    ...
                    if (extendNode && extendNode.kind == node_10.NodeKind.EXTENDS) {
    ...
    return {
        ...
        execute: function () {
            ...
            (function (NodeKind) {
                ...
                NodeKind[NodeKind["SUPER"] = 51] = "SUPER";
